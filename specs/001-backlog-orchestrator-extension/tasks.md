...
- [ ] T019 [P] [US1] Implement `safety-check.sh` at `.specify/extensions/orchestrate/scripts/sh/safety-check.sh`. Two subcommands:
...
- [ ] T025 [US1] Wire the orchestration playbook into the Lead Skill body in both files from T016. Pseudocode the playbook MUST follow:
...
- [ ] T034 [US3] Extend the Lead Skill body in both T016 files (after T028) with:
